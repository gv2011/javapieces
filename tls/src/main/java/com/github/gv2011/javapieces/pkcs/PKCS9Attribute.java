...
import com.github.gv2011.javapieces.x509.CertificateExtensions;
...
//                Class.forName("sun.security.x509.CertificateExtensions")
    ...
    private void init(final ObjectIdentifier oid, final Object value)
        ...
        final Class<?> clazz = index == -1 ? BYTE_ARRAY_CLASS: VALUE_CLASSES[index];
    ...
    public void derEncode(final OutputStream out) throws IOException {
        ...
        case 14:     // ExtensionRequest
            {
                final DerOutputStream temp2 = new DerOutputStream();
                final CertificateExtensions exts = (CertificateExtensions)value;
                try {
    ...
    throws IOException {
        final Byte[] expectedTags = PKCS9_VALUE_TAGS[index];
