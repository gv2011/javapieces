...
public class TlsKeyMaterialSpec implements KeySpec, SecretKey {
     ...
     */
    public TlsKeyMaterialSpec(final SecretKey clientMacKey, final SecretKey serverMacKey,
            final SecretKey clientCipherKey, final SecretKey serverCipherKey) {
     ...
     */
    public TlsKeyMaterialSpec(final SecretKey clientMacKey, final SecretKey serverMacKey,
            final SecretKey clientCipherKey, final IvParameterSpec clientIv,
            final SecretKey serverCipherKey, final IvParameterSpec serverIv) {
