...
import static com.github.gv2011.javapieces.suntls.CipherSuite.KeyExchange.K_DHE_DSS;
import static com.github.gv2011.javapieces.suntls.CipherSuite.KeyExchange.K_DHE_RSA;
import static com.github.gv2011.javapieces.suntls.CipherSuite.KeyExchange.K_DH_ANON;
import static com.github.gv2011.javapieces.suntls.CipherSuite.KeyExchange.K_ECDHE_ECDSA;
import static com.github.gv2011.javapieces.suntls.CipherSuite.KeyExchange.K_ECDHE_RSA;
import static com.github.gv2011.javapieces.suntls.CipherSuite.KeyExchange.K_ECDH_ANON;
import static com.github.gv2011.javapieces.suntls.CipherSuite.KeyExchange.K_ECDH_ECDSA;
import static com.github.gv2011.javapieces.suntls.CipherSuite.KeyExchange.K_ECDH_RSA;
...
import static com.github.gv2011.javapieces.suntls.CipherSuite.KeyExchange.K_NULL;
...
import static com.github.gv2011.javapieces.suntls.CipherSuite.KeyExchange.K_SCSV;
import static com.github.gv2011.javapieces.suntls.CipherSuite.PRF.P_NONE;
import static com.github.gv2011.javapieces.suntls.CipherSuite.PRF.P_SHA256;
import static com.github.gv2011.javapieces.suntls.CipherSuite.PRF.P_SHA384;
import static com.github.gv2011.javapieces.suntls.JsseJce.CIPHER_3DES;
import static com.github.gv2011.javapieces.suntls.JsseJce.CIPHER_AES;
import static com.github.gv2011.javapieces.suntls.JsseJce.CIPHER_AES_GCM;
import static com.github.gv2011.javapieces.suntls.JsseJce.CIPHER_DES;
import static com.github.gv2011.javapieces.suntls.JsseJce.CIPHER_RC4;
...
final class CipherSuite implements Comparable<CipherSuite> {
     ...
     */
    private CipherSuite(final String name, final int id, final int priority,
            final KeyExchange keyExchange, final BulkCipher cipher,
            boolean allowed, final int obsoleted, final int supported, final PRF prfAlg) {
        this.name = name;
        this.id = id;
        this.priority = priority;
        this.keyExchange = keyExchange;
        this.cipher = cipher;
        exportable = cipher.exportable;
    ...
    private CipherSuite(final String name, final int id) {
        ...
        macAlg = null;
        exportable = false;
        obsoleted = ProtocolVersion.LIMIT_MAX_VALUE;
        supported = ProtocolVersion.LIMIT_MIN_VALUE;
        prfAlg = P_NONE;
    }
    ...
    static CipherSuite valueOf(final String s) {
        ...
        final CipherSuite c = nameMap.get(s);
     ...
     */
    private static void add(final String name, final int id, final int priority,
            final KeyExchange keyExchange, final BulkCipher cipher,
            final boolean allowed, final int obsoleted, final int supported, final PRF prf) {

        final CipherSuite c = new CipherSuite(name, id, priority, keyExchange,
    ...
    private static void add(final String name, final int id, final int priority,
            final KeyExchange keyExchange, final BulkCipher cipher,
            final boolean allowed, final int obsoleted) {
     ...
     */
    private static void add(final String name, final int id, final int priority,
            final KeyExchange keyExchange, final BulkCipher cipher, final boolean allowed) {
    ...
    static enum KeyExchange {
        ...
        KeyExchange(final String name, final boolean allowed, final boolean isEC) {
            this.name = name;
            this.allowed = allowed;
            this.isEC = isEC;
            alwaysAvailable = allowed &&
    ...
    final static class BulkCipher {
        ...
        BulkCipher(final String transformation, final CipherType cipherType, final int keySize,
                final int expandedKeySize, final int ivSize,
                final int fixedIvSize, final boolean allowed) {

            this.transformation = transformation;
            final String[] splits = transformation.split("/");
            algorithm = splits[0];
            this.cipherType = cipherType;
            description = algorithm + "/" + (keySize << 3);
        ...
        BulkCipher(final String transformation, final CipherType cipherType, final int keySize,
                final int ivSize, final int fixedIvSize, final boolean allowed) {
            this.transformation = transformation;
            final String[] splits = transformation.split("/");
            algorithm = splits[0];
            this.cipherType = cipherType;
         ...
         */
        CipherBox newCipher(final ProtocolVersion version, final SecretKey key,
                final IvParameterSpec iv, final SecureRandom random,
    ...
    final static class MacAlg {
        ...
        MacAlg(final String name, final int size,
                final int hashBlockSize, final int minimalPaddingSize) {
            this.name = name;
            this.size = size;
         ...
         * @exception NoSuchAlgorithmException if anything goes wrong
         */
        MAC newMac(final ProtocolVersion protocolVersion, final SecretKey secret)
    ...
    static enum PRF {
        ...
        PRF(final String prfHashAlg, final int prfHashLength, final int prfBlockSize) {
    ...
    static {
        ...
        final int max = ProtocolVersion.LIMIT_MAX_VALUE;
