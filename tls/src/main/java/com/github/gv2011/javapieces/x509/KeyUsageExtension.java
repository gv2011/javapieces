...
implements CertAttrSet<String> {
    ...
    private void encodeThis() throws IOException {
        ...
        os.putTruncatedUnalignedBitString(new BitArray(bitString));
    ...
    throws IOException {
        ...
        if (extValue[0] == DerValue.tag_OctetString) {
            extensionValue = new DerValue(extValue).getOctetString();
        } else {
            extensionValue = extValue;
        }
        final DerValue val = new DerValue(extensionValue);
        bitString = val.getUnalignedBitString().toBooleanArray();
    }
