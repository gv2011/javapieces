...
import com.github.gv2011.javapieces.timestamp.HttpTimestamper;
import com.github.gv2011.javapieces.timestamp.TSRequest;
import com.github.gv2011.javapieces.timestamp.TSResponse;
import com.github.gv2011.javapieces.timestamp.TimestampToken;
import com.github.gv2011.javapieces.timestamp.Timestamper;
...
import com.github.gv2011.javapieces.x509.X509CertInfo;
...
public class PKCS7 {
        ...
        throws IOException
    {
        ...
        final DerValue content = contentInfo.getContent();
        ...
        throws IOException
    {
        ...
        if (certificates != null && certificates.length != 0) {
            ...
            final X509CertImpl implCerts[] = new X509CertImpl[certificates.length];
        ...
        if (crls != null && crls.length != 0) {
            ...
            final Set<X509CRLImpl> implCRLs = new HashSet<>(crls.length);
    ...
    throws NoSuchAlgorithmException, SignatureException {
        ...
        final Vector<SignerInfo> intResult = new Vector<>();
        for (int i = 0; i < signerInfos.length; i++) {

            final SignerInfo signerInfo = verify(signerInfos[i], bytes);
            if (signerInfo != null) {
        ...
        throws CertificateException, IOException, NoSuchAlgorithmException
    {
        ...
        if (tsaURI != null) {
            ...
            final byte[] tsToken = generateTimestampToken(
        ...
        throws IOException, CertificateException
    {
        ...
        } catch (final NoSuchAlgorithmException nase) {
