...
public class DSAKeyFactory extends KeyFactorySpi {
    ...
    static {
         ...
         */
        final String prop = AccessController.doPrivileged
    ...
    throws InvalidKeySpecException {
        try {
            if (keySpec instanceof DSAPublicKeySpec) {
                final DSAPublicKeySpec dsaPubKeySpec = (DSAPublicKeySpec)keySpec;
                if (SERIAL_INTEROP) {
    ...
    throws InvalidKeySpecException {
        try {
            if (keySpec instanceof DSAPrivateKeySpec) {
                final DSAPrivateKeySpec dsaPrivKeySpec = (DSAPrivateKeySpec)keySpec;
    ...
    protected <T extends KeySpec>
        T engineGetKeySpec(final Key key, final Class<T> keySpec)
    throws InvalidKeySpecException {
        ...
        try {
            ...
            if (key instanceof java.security.interfaces.DSAPublicKey) {
                ...
                final Class<?> dsaPubKeySpec = Class.forName
                    ("java.security.spec.DSAPublicKeySpec");
                final Class<?> x509KeySpec = Class.forName
                    ("java.security.spec.X509EncodedKeySpec");

                if (dsaPubKeySpec.isAssignableFrom(keySpec)) {
                    final java.security.interfaces.DSAPublicKey dsaPubKey
                ...
                // Determine valid key specs
                final Class<?> dsaPrivKeySpec = Class.forName
                    ("java.security.spec.DSAPrivateKeySpec");
                final Class<?> pkcs8KeySpec = Class.forName
                    ("java.security.spec.PKCS8EncodedKeySpec");

                if (dsaPrivKeySpec.isAssignableFrom(keySpec)) {
                    final java.security.interfaces.DSAPrivateKey dsaPrivKey
    ...
    protected Key engineTranslateKey(final Key key) throws InvalidKeyException {
        ...
        try {
            ...
            if (key instanceof java.security.interfaces.DSAPublicKey) {
                ...
                if (key instanceof com.github.gv2011.javapieces.provider.DSAPublicKey) {
                    return key;
                }
                // Convert key to spec
                ...
                // Check if key originates from this factory
                if (key instanceof com.github.gv2011.javapieces.provider.DSAPrivateKey) {
                    return key;
                }
                // Convert key to spec
