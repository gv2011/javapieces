...
import com.github.gv2011.javapieces.secutil.IPAddressUtil;
...
final class Utilities {
    ...
    static List<SNIServerName> addToSNIServerNameList(
            final List<SNIServerName> serverNames, final String hostname) {
        ...
        final List<SNIServerName> sniList = (size != 0) ?
