...
class AdaptableX509CertSelector extends X509CertSelector {
     ...
     */
    void setSkiAndSerialNumber(final AuthorityKeyIdentifierExtension ext)
        throws IOException {
        ...
        if (ext != null) {
            ...
            final SerialNumber asn = (SerialNumber)ext.get(
    ...
    public boolean match(final Certificate cert) {
        ...
        final int version = xcert.getVersion();
     ...
     */
    private boolean matchSubjectKeyID(final X509Certificate xcert) {
        if (ski == null) {
            return true;
        }
        try {
            final byte[] extVal = xcert.getExtensionValue("2.5.29.14");
            if (extVal == null) {
                if (debug != null) {
            ...
            final byte[] certSubjectKeyID = in.getOctetString();
    ...
    @Override
    public Object clone() {
        final AdaptableX509CertSelector copy =
