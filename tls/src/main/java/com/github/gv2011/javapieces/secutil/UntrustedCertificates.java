...
public final class UntrustedCertificates {
    ...
    static {
        AccessController.doPrivileged((PrivilegedAction<Void>) () -> {
            final File f = new File(System.getProperty("java.home"),
    ...
    private static String stripColons(final Object input) {
     ...
     */
    public static boolean isUntrusted(final X509Certificate cert) {
        if (algorithm == null) {
            return false;
        }
        String key;
        if (cert instanceof X509CertImpl) {
            ...
            } catch (final CertificateException cee) {
                return false;
            }
        }
