...
public class X509CertificatePair {
    ...
    private void checkPair() throws CertificateException {
         ...
         * are a valid pair.
         */
        final X500Principal fwSubject = forward.getSubjectX500Principal();
        final X500Principal fwIssuer = forward.getIssuerX500Principal();
        final X500Principal rvSubject = reverse.getSubjectX500Principal();
        final X500Principal rvIssuer = reverse.getIssuerX500Principal();
