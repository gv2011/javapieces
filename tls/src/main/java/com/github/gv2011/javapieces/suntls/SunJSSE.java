...
public final class SunJSSE extends java.security.Provider {
    ...
    private static synchronized void ensureFIPS(final java.security.Provider p) {
        if (fips == null) {
            fips = true;
            cryptoProvider = p;
        } else {
...
//        if ((Class<?>)getClass() != (Class<?>)ProviderImp.class) {
