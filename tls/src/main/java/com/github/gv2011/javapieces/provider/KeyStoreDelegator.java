...
class KeyStoreDelegator extends KeyStoreSpi {
    ...
    public KeyStoreDelegator(
        ...
        final Class<? extends KeyStoreSpi> primaryKeyStore,
        final String secondaryType,
        final Class<? extends KeyStoreSpi> secondaryKeyStore) {
        ...
        compatModeEnabled = "true".equalsIgnoreCase(
            AccessController.doPrivileged(
                (PrivilegedAction<String>) () -> Security.getProperty(KEYSTORE_TYPE_COMPAT)
            ));
