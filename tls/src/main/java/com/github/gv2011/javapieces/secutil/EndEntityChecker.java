...
class EndEntityChecker {
    ...
    void check(final X509Certificate cert, final Object parameter)
     ...
     */
    private void checkRemainingExtensions(final Set<String> exts)
            throws CertificateException {
     ...
     */
    private boolean checkEKU(final X509Certificate cert, final Set<String> exts,
            final String expectedEKU) throws CertificateException {
     ...
     */
    private boolean checkKeyUsage(final X509Certificate cert, final int bit)
            throws CertificateException {
     ...
     * @throws CertificateException if not.
     */
    private void checkTLSClient(final X509Certificate cert)
            throws CertificateException {
        final Set<String> exts = getCriticalExtensions(cert);
     ...
     * @throws CertificateException if not.
     */
    private void checkTLSServer(final X509Certificate cert, final String parameter)
            throws CertificateException {
        final Set<String> exts = getCriticalExtensions(cert);
     ...
     * @throws CertificateException if not.
     */
    private void checkCodeSigning(final X509Certificate cert)
            throws CertificateException {
        final Set<String> exts = getCriticalExtensions(cert);
     ...
     * @throws CertificateException if not.
     */
    private void checkTSAServer(final X509Certificate cert)
            throws CertificateException {
        final Set<String> exts = getCriticalExtensions(cert);
