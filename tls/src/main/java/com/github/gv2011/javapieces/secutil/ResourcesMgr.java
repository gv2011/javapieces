...
public class ResourcesMgr {
    ...
    public static String getString(final String s, final String altBundleName) {

        if (altBundle == null) {

            // only load if/when needed
            altBundle = java.security.AccessController.doPrivileged(
                (PrivilegedAction<ResourceBundle>) () -> (java.util.ResourceBundle.getBundle(altBundleName)));
        }
