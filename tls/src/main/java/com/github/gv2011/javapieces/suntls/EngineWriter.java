...
final class EngineWriter {
     ...
     */
    private final LinkedList<Object> outboundList;
     ...
     * data.
     */
    private HandshakeStatus getOutboundData(final ByteBuffer dstBB) {
     ...
     * other writeRecord.
     */
    synchronized void writeRecord(final EngineOutputRecord outputRecord,
            final Authenticator authenticator,
            final CipherBox writeCipher) throws IOException {
    ...
    synchronized HandshakeStatus writeRecord(
            final EngineOutputRecord outputRecord, final EngineArgs ea,
            final Authenticator authenticator,
            final CipherBox writeCipher) throws IOException {
         ...
         */
        if (hasOutboundDataInternal()) {
            final HandshakeStatus hss = getOutboundData(ea.netData);
     ...
     */
    synchronized void putOutboundDataSync(final ByteBuffer bytes)
            throws IOException {
