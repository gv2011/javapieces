...
public class EncryptedPrivateKeyInfo {
     ...
     * its encoding.
     */
    public EncryptedPrivateKeyInfo(final byte[] encoded)
        throws IOException
    {
        if (encoded == null) {
        ...
        final DerValue[] seq = new DerValue[2];
     ...
     */
    public EncryptedPrivateKeyInfo(final AlgorithmId algid, final byte[] encryptedData) {
        this.algid = algid;
    ...
    public boolean equals(final Object other) {
        ...
        if (!(other instanceof EncryptedPrivateKeyInfo))
            return false;
        try {
            final byte[] thisEncrInfo = getEncoded();
            final byte[] otherEncrInfo
