...
import com.github.gv2011.javapieces.pkcs.PKCS9Attribute;
...
import com.github.gv2011.javapieces.secutil.GetBooleanAction;
...
public class AVA implements DerEncoder {
    ...
    public String getValueString() {
        try {
            final String s = value.getAsString();
            if (s == null) {
    ...
    private DerValue parseQuotedString
        ...
        if (oid.equals((Object)PKCS9Attribute.EMAIL_ADDRESS_OID) ||
            (oid.equals((Object)X500Name.DOMAIN_COMPONENT_OID) &&
    ...
    private static Byte getEmbeddedHexPair(final int c1, final Reader in)
        ...
        if (hexDigits.indexOf(Character.toUpperCase((char)c1)) >= 0) {
            final int c2 = readChar(in, "unexpected EOF - " +
    ...
    public boolean equals(final Object obj) {
        ...
        return toRFC2253CanonicalString().equals
    ...
    private String toKeywordValueString(final String keyword) {
        ...
        try {
            final String valStr = value.getAsString();
