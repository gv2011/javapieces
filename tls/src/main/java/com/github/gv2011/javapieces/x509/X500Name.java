...
public class X500Name implements GeneralNameInterface, Principal {
    ...
    public boolean equals(final Object obj) {
        ...
        if ((canonicalDn != null) && (other.canonicalDn != null)) {
            return canonicalDn.equals(other.canonicalDn);
        }
        ...
        final String thisCanonical = getRFC2253CanonicalName();
    ...
    private DerValue findAttribute(final ObjectIdentifier attribute) {
        if (names != null) {
            for (int i = 0; i < names.length; i++) {
                final DerValue value = names[i].findAttribute(attribute);
                if (value != null) {
                    return value;
                }
            }
    ...
    static ObjectIdentifier intern(final ObjectIdentifier oid) {
        final ObjectIdentifier interned = internedOIDs.putIfAbsent(oid, oid);
    ...
    public X500Name commonAncestor(final X500Name other) {
        ...
        final int thisLen = names.length;
