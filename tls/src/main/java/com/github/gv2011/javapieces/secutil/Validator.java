...
public abstract class Validator {
     ...
     */
    public static Validator getInstance(final String type, final String variant,
            final KeyStore ks) {
     ...
     */
    public final X509Certificate[] validate(final X509Certificate[] chain)
     ...
     */
    public final X509Certificate[] validate(final X509Certificate[] chain,
        final Collection<X509Certificate> otherCerts) throws CertificateException {
     ...
     */
    public final X509Certificate[] validate(final X509Certificate[] chain,
            final Collection<X509Certificate> otherCerts, final Object parameter)
            throws CertificateException {
