...
public class ConstraintsParameters {
    ...
    public ConstraintsParameters(final X509Certificate c, final boolean match,
            final Date pkixdate, final Timestamp jarTime, final String variant) {
        cert = c;
        trustedMatch = match;
        pkixDate = pkixdate;
    ...
    public ConstraintsParameters(final String algorithm, final AlgorithmParameters params,
            final Key key, final String variant) {
    ...
    public ConstraintsParameters(final X509Certificate c) {
        this(c, false, null, null,
                Validator.VAR_GENERIC);
    }

    public ConstraintsParameters(final Timestamp jarTime) {
