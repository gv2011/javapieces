...
public final class ProviderList {
    ...
    final static com.github.gv2011.javapieces.secutil.Debug debug =
        com.github.gv2011.javapieces.secutil.Debug.getInstance("jca", "ProviderList");
    ...
    private ProviderList() {
        ...
        for (int i = 1; true; i++) {
            ...
            if (k == -1) {
                ...
                final String className = entry.substring(0, k);
     ...
     */
    ProviderList getJarList(final String[] jarClassNames) {
    ...
    private final class ServiceList extends AbstractList<Service> {
        ...
        private Service tryGet(final int index) {
            while (true) {
                ...
                final Provider p = getProvider(providerIndex++);
                if (type != null) {
                    // simple lookup
