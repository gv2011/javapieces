...
import com.github.gv2011.javapieces.provider.ParseUtil;
...
public class PolicyUtil {
    ...
    public static KeyStore getKeyStore
                (final URL policyUrl,                 // URL of policy file
                final String keyStoreName,            // input: keyStore URL
                String keyStoreType,            // input: keyStore type
                final String keyStoreProvider,        // input: keyStore provider
                final String storePassURL,            // input: keyStore password
                final Debug debug)
