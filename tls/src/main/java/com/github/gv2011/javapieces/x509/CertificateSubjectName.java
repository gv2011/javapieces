...
public class CertificateSubjectName implements CertAttrSet<String> {
     ...
     */
    public CertificateSubjectName(final X500Name name) {
        dnName = name;
    }
     ...
     */
    public CertificateSubjectName(final DerInputStream in) throws IOException {
     ...
     * @exception IOException on decoding errors.
     */
    public CertificateSubjectName(final InputStream in) throws IOException {
