...
import com.github.gv2011.javapieces.tls.KeyManager;
import com.github.gv2011.javapieces.tls.KeyManagerFactory;
import com.github.gv2011.javapieces.tls.SSLContextSpi;
import com.github.gv2011.javapieces.tls.SSLEngine;
import com.github.gv2011.javapieces.tls.SSLServerSocketFactory;
import com.github.gv2011.javapieces.tls.SSLSession;
import com.github.gv2011.javapieces.tls.SSLSessionContext;
import com.github.gv2011.javapieces.tls.SSLSocket;
import com.github.gv2011.javapieces.tls.SSLSocketFactory;
import com.github.gv2011.javapieces.tls.TrustManager;
import com.github.gv2011.javapieces.tls.TrustManagerFactory;
...
public abstract class SSLContextImpl extends SSLContextSpi {
    ...
    @Override
    protected void engineInit(final KeyManager[] km, TrustManager[] tm,
                                final SecureRandom sr) throws KeyManagementException {
        isInitialized = false;
    ...
    private X509TrustManager chooseTrustManager(final TrustManager[] tm)
    ...
    private X509ExtendedKeyManager chooseKeyManager(final KeyManager[] kms)
            throws KeyManagementException {
    ...
    private static CipherSuiteList getApplicableCipherSuiteList(
            final ProtocolList protocols, final boolean onlyEnabled) {
        ...
        final Collection<CipherSuite> allowedCipherSuites =
                                    CipherSuite.allowedCipherSuites();

        final TreeSet<CipherSuite> suites = new TreeSet<>();
    ...
    private static String[] getAvailableProtocols(
            final ProtocolVersion[] protocolCandidates) {
    ...
    private static class CustomizedTLSContext extends AbstractTLSContext {
        ...
        static {
            ...
            if (reservedException == null) {
                final ArrayList<ProtocolVersion>
                        customizedTLSProtocols = new ArrayList<>();
                for (final ProtocolVersion protocol :
            ...
            try {
                if (defaultKeyStore.length() != 0 &&
                    ...
                    fs = AccessController.doPrivileged(
                            (PrivilegedExceptionAction<FileInputStream>) () -> new FileInputStream(defaultKeyStore));
                }
    ...
    public static final class DefaultSSLContext extends CustomizedTLSContext {
        ...
        @Override
        protected void engineInit(final KeyManager[] km, final TrustManager[] tm,
                                  final SecureRandom sr) throws KeyManagementException {
            throw new KeyManagementException
...
final class AbstractTrustManagerWrapper extends X509ExtendedTrustManager
    ...
    private void checkAdditionalTrust(final X509Certificate[] chain, final String authType,
        ...
        if (socket != null && socket.isConnected() &&
            ...
            if (protocolVersion.v >= ProtocolVersion.TLS12.v) {
                if (session instanceof ExtendedSSLSession) {
                    ...
                    final String[] peerSupportedSignAlgs =
    ...
    private void checkAlgorithmConstraints(final X509Certificate[] chain,
            final AlgorithmConstraints constraints, final boolean isClient) throws CertificateException {

        try {
            // Does the certificate chain end with a trusted certificate?
            int checkedLength = chain.length - 1;

            final Collection<X509Certificate> trustedCerts = new HashSet<>();
            ...
            if (checkedLength >= 0) {
                final AlgorithmChecker checker =
