...
public class DistributionPoint {
    ...
    public void encode(final DerOutputStream out) throws IOException {
        ...
        if (reasonFlags != null) {
            ...
            final BitArray rf = new BitArray(reasonFlags);
    ...
    public boolean equals(final Object obj) {
        ...
        final boolean equal = Objects.equals(fullName, other.fullName)
                     && Objects.equals(relativeName, other.relativeName)
                     && Objects.equals(crlIssuer, other.crlIssuer)
                     && Arrays.equals(reasonFlags, other.reasonFlags);
        return equal;
    }
