...
public class CertificateIssuerName implements CertAttrSet<String> {
     ...
     */
    public CertificateIssuerName(final X500Name name) {
        dnName = name;
    }
     ...
     */
    public CertificateIssuerName(final DerInputStream in) throws IOException {
     ...
     * @exception IOException on decoding errors.
     */
    public CertificateIssuerName(final InputStream in) throws IOException {
