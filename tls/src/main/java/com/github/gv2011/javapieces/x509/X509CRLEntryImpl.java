...
public class X509CRLEntryImpl extends X509CRLEntry
    ...
    public X509CRLEntryImpl(final BigInteger num, final Date date) {
        serialNumber = new SerialNumber(num);
        revocationDate = date;
    }
    ...
    public static CRLReason getRevocationReason(final X509CRLEntry crlEntry) {
        try {
            final byte[] ext = crlEntry.getExtensionValue("2.5.29.21");
            if (ext == null) {
                return null;
            }
    ...
    public String toString() {
        ...
        if (extensions != null) {
            final Collection<Extension> allEntryExts = extensions.getAllExtensions();
    ...
    throws CRLException, IOException {
        ...
        // crlEntryExtensions
        extensions = new CRLExtensions(derVal.toDerInputStream());
    }
    ...
    public Map<String, java.security.cert.Extension> getExtensions() {
        ...
        final Collection<Extension> exts = extensions.getAllExtensions();
    ...
    public int compareTo(final X509CRLEntryImpl that) {
        ...
        try {
            final byte[] thisEncoded = getEncoded0();
