...
public class PKIXExtendedParameters extends PKIXBuilderParameters {
    ...
    public PKIXExtendedParameters(final PKIXBuilderParameters params,
            final Timestamp timestamp, final String variant)
    ...
    public void setTimestamp(final Timestamp t) {
        jarTimestamp = t;
    }
    ...
    @Override
    public void addCertPathChecker(final PKIXCertPathChecker c) {
    ...
    @Override
    public void setTrustAnchors(final Set<TrustAnchor> trustAnchors)
            throws InvalidAlgorithmParameterException {
