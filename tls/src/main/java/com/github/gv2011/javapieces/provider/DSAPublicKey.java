...
import com.github.gv2011.javapieces.x509.X509Key;
...
implements java.security.interfaces.DSAPublicKey, Serializable {
     ...
     */
    public DSAPublicKey(final BigInteger y, final BigInteger p, final BigInteger q,
                        final BigInteger g)
    throws InvalidKeyException {
        ...
        try {
            final byte[] keyArray = new DerValue(DerValue.tag_Integer,
     ...
     */
    public DSAPublicKey(final byte[] encoded) throws InvalidKeyException {
        decode(encoded);
    }
    ...
    protected void parseKeyBits() throws InvalidKeyException {
        try {
            final DerInputStream in = new DerInputStream(getKey().toByteArray());
            y = in.getBigInteger();
        } catch (final IOException e) {
