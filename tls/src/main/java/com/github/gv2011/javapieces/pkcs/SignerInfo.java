...
import com.github.gv2011.javapieces.secutil.ConstraintsParameters;
...
import com.github.gv2011.javapieces.x509.KeyUsageExtension;
...
public class SignerInfo implements DerEncoder {
    ...
    throws NoSuchAlgorithmException, SignatureException {
        ...
        try {
            ...
            final ConstraintsParameters cparams =
               ...
               CertificateException
    {
        ...
        final PKCS7 tsToken = getTsToken();
        if (tsToken == null) {
            hasTimestamp = false;
            return null;
        }
    ...
    private void verifyTimestamp(final TimestampToken token)
        throws NoSuchAlgorithmException, SignatureException {
        final String digestAlgname = token.getHashAlgorithm().getName();
