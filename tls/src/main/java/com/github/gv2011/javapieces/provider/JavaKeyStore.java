...
import com.github.gv2011.javapieces.pkcs.EncryptedPrivateKeyInfo;
import com.github.gv2011.javapieces.pkcs.PKCS12KeyStore;
import com.github.gv2011.javapieces.secutil.IOUtils;
...
abstract class JavaKeyStore extends KeyStoreSpi {
    ...
    public static final class DualFormatJKS extends KeyStoreDelegator {
        public DualFormatJKS() {
            super("JKS", (Class<? extends KeyStoreSpi>)JKS.class, "PKCS12", (Class<? extends KeyStoreSpi>)PKCS12KeyStore.class);
        }
    }
        ...
        throws NoSuchAlgorithmException, UnrecoverableKeyException
    {
        ...
        final KeyProtector keyProtector = new KeyProtector(password);
        final byte[] encrBytes = ((KeyEntry)entry).protectedPrivKey;
        ...
        throws KeyStoreException
    {
        ...
        try {
            synchronized(entries) {
                final KeyEntry entry = new KeyEntry();
                entry.date = new Date();
    ...
    public String engineGetCertificateAlias(final Certificate cert) {
        ...
        for (final Enumeration<String> e = entries.keys(); e.hasMoreElements(); ) {
            ...
            final Object entry = entries.get(alias);
            if (entry instanceof TrustedCertEntry) {
        ...
        throws IOException, NoSuchAlgorithmException, CertificateException
    {
        synchronized(entries) {
            ...
            final MessageDigest md = getPreKeyedHash(password);
        ...
        throws IOException, NoSuchAlgorithmException, CertificateException
    {
        synchronized(entries) {
            ...
            final int xMagic = dis.readInt();
            final int xVersion = dis.readInt();
            ...
            for (int i = 0; i < count; i++) {
                ...
                if (tag == 1) { // private key entry
                    ...
                    final int numOfCerts = dis.readInt();
                    if (numOfCerts > 0) {
                        ...
                        for (int j = 0; j < numOfCerts; j++) {
                            if (xVersion == 2) {
                                ...
                                final String certType = dis.readUTF();
                    ...
                    final TrustedCertEntry entry = new TrustedCertEntry();
            ...
            if (password != null) {
                ...
                for (int i = 0; i < computed.length; i++) {
                    if (computed[i] != actual[i]) {
                        final Throwable t = new UnrecoverableKeyException
     ...
     */
    private MessageDigest getPreKeyedHash(final char[] password)
        throws NoSuchAlgorithmException, UnsupportedEncodingException
    {
        int i, j;

        final MessageDigest md = MessageDigest.getInstance("SHA");
        final byte[] passwdBytes = new byte[password.length * 2];
