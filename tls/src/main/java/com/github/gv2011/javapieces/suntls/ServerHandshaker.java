...
import static com.github.gv2011.javapieces.suntls.CipherSuite.KeyExchange.K_DH_ANON;
import static com.github.gv2011.javapieces.suntls.CipherSuite.KeyExchange.K_ECDH_ANON;
import static com.github.gv2011.javapieces.suntls.CipherSuite.KeyExchange.K_KRB5;
import static com.github.gv2011.javapieces.suntls.CipherSuite.KeyExchange.K_KRB5_EXPORT;
...
import com.github.gv2011.javapieces.secutil.KeyUtil;
import com.github.gv2011.javapieces.secutil.LegacyAlgorithmConstraints;
import com.github.gv2011.javapieces.suntls.CipherSuite.KeyExchange;
import com.github.gv2011.javapieces.suntls.HandshakeMessage.CertificateMsg;
import com.github.gv2011.javapieces.suntls.HandshakeMessage.CertificateRequest;
import com.github.gv2011.javapieces.suntls.HandshakeMessage.CertificateVerify;
import com.github.gv2011.javapieces.suntls.HandshakeMessage.ClientHello;
import com.github.gv2011.javapieces.suntls.HandshakeMessage.DH_ServerKeyExchange;
import com.github.gv2011.javapieces.suntls.HandshakeMessage.ECDH_ServerKeyExchange;
import com.github.gv2011.javapieces.suntls.HandshakeMessage.Finished;
import com.github.gv2011.javapieces.suntls.HandshakeMessage.HelloRequest;
import com.github.gv2011.javapieces.suntls.HandshakeMessage.RSA_ServerKeyExchange;
import com.github.gv2011.javapieces.suntls.HandshakeMessage.ServerHello;
import com.github.gv2011.javapieces.suntls.HandshakeMessage.ServerHelloDone;
import com.github.gv2011.javapieces.suntls.HandshakeMessage.ServerKeyExchange;
import com.github.gv2011.javapieces.suntls.SignatureAndHashAlgorithm.HashAlgorithm;
import com.github.gv2011.javapieces.suntls.SignatureAndHashAlgorithm.SignatureAlgorithm;
import com.github.gv2011.javapieces.tls.SNIServerName;
import com.github.gv2011.javapieces.tls.SSLException;
import com.github.gv2011.javapieces.tls.SSLHandshakeException;
import com.github.gv2011.javapieces.tls.SSLPeerUnverifiedException;
import com.github.gv2011.javapieces.tls.SSLProtocolException;
import com.github.gv2011.javapieces.tls.X509ExtendedKeyManager;
...
final class ServerHandshaker extends Handshaker {
     ...
     */
    ServerHandshaker(final SSLSocketImpl socket, final SSLContextImpl context,
            final ProtocolList enabledProtocols, final byte clientAuth,
            final ProtocolVersion activeProtocolVersion, final boolean isInitialHandshake,
            final boolean secureRenegotiation,
            final byte[] clientVerifyData, final byte[] serverVerifyData) {
     ...
     * Constructor ... use the keys found in the auth context.
     */
    ServerHandshaker(final SSLEngineImpl engine, final SSLContextImpl context,
            final ProtocolList enabledProtocols, final byte clientAuth,
            final ProtocolVersion activeProtocolVersion,
            final boolean isInitialHandshake, final boolean secureRenegotiation,
            final byte[] clientVerifyData, final byte[] serverVerifyData) {
     ...
     */
    @Override
    void processMessage(final byte type, final int message_len)
            throws IOException {
        //
        ...
        switch (type) {
            case HandshakeMessage.ht_client_hello:
                final ClientHello ch = new ClientHello(input, message_len);
                /*
            ...
            case HandshakeMessage.ht_certificate:
                ...
                clientCertificate(new CertificateMsg(input));
                break;
            ...
            case HandshakeMessage.ht_client_key_exchange:
                ...
                case K_RSA_EXPORT:
                     ...
                     * certificates/keys.
                     */
                    final RSAClientKeyExchange pms = new RSAClientKeyExchange(
            ...
            case HandshakeMessage.ht_certificate_verify:
                clientCertificateVerify(new CertificateVerify(input,
     ...
     */
    private void clientHello(final ClientHello mesg) throws IOException {
        ...
        final ServerNameExtension clientHelloSNIExt = (ServerNameExtension)
        ...
        final RenegotiationInfoExtension clientHelloRI = (RenegotiationInfoExtension)
         ...
         */
        final ServerHello m1 = new ServerHello();
        ...
        if (mesg.sessionId.length() != 0) {
            ...
            final SSLSessionImpl previous = ((SSLSessionContextImpl)sslContext
            ...
            if (previous != null) {
                ...
                if (resumingSession) {
                    final List<SNIServerName> oldServerNames =
                    ...
                    if (suite.keyExchange == K_KRB5 ||
                        ...
                        try {
                            subject = AccessController.doPrivileged(
                                (PrivilegedExceptionAction<Subject>) () -> Krb5Helper.getServerSubject(getAccSE()));
        ...
        if (session == null) {
            ...
            if (protocolVersion.v >= ProtocolVersion.TLS12.v) {
                final SignatureAlgorithmsExtension signAlgs =
                    (SignatureAlgorithmsExtension)mesg.extensions.get(
                                    ExtensionType.EXT_SIGNATURE_ALGORITHMS);
                if (signAlgs != null) {
                    final Collection<SignatureAndHashAlgorithm> peerSignAlgs =
                    ...
                    final Collection<SignatureAndHashAlgorithm>
        ...
        if (secureRenegotiation) {
            ...
            final HelloExtension serverHelloRI = new RenegotiationInfoExtension(
                                        clientVerifyData, serverVerifyData);
        ...
        if (keyExchange == K_KRB5 || keyExchange == K_KRB5_EXPORT) {
            ...
            final CertificateMsg m2 = new CertificateMsg(certs);
        ...
        if (doClientAuth != SSLEngineImpl.clauth_none &&
            ...
            if (protocolVersion.v >= ProtocolVersion.TLS12.v) {
                ...
                final Set<String> localHashAlgs =
         ...
         */
        final ServerHelloDone m5 = new ServerHelloDone();
     ...
     */
    private void chooseCipherSuite(final ClientHello mesg) throws IOException {
        ...
        final List<CipherSuite> legacySuites = new ArrayList<>();
    ...
    boolean trySetCipherSuite(final CipherSuite suite) {
        ...
        final KeyExchange keyExchange = suite.keyExchange;
    ...
    private boolean setupEphemeralRSAKeys(final boolean export) {
        final KeyPair kp = sslContext.getEphemeralKeyManager().
    ...
    private boolean setupEphemeralECDHKeys() {
        final int index = (requestedCurves != null) ?
    ...
    private boolean setupPrivateKeyAndChain(final String algorithm) {
        final X509ExtendedKeyManager km = sslContext.getX509KeyManager();
        String alias;
        if (conn != null) {
        ...
        if (keyAlgorithm.equals("EC")) {
            ...
            final int id = SupportedEllipticCurvesExtension.getCurveIndex(params);
    ...
    private boolean setupKerberosKeys() {
        ...
        try {
            ...
            serviceCreds = AccessController.doPrivileged(
                (PrivilegedExceptionAction<Object>) () -> Krb5Helper.getServiceCreds(acc));
     ...
     */
    private SecretKey clientKeyExchange(final KerberosClientKeyExchange mesg)
        throws IOException {
     ...
     * pre-master secret.
     */
    private SecretKey clientKeyExchange(final DHClientKeyExchange mesg)
            throws IOException {
    ...
    private SecretKey clientKeyExchange(final ECDHClientKeyExchange mesg)
            throws IOException {
     ...
     */
    private void clientCertificateVerify(final CertificateVerify mesg)
            throws IOException {
        ...
        if (protocolVersion.v >= ProtocolVersion.TLS12.v) {
            final SignatureAndHashAlgorithm signAlg =
        ...
        try {
            ...
            final boolean valid = mesg.verify(protocolVersion, handshakeHash,
     ...
     */
    private void clientFinished(final Finished mesg) throws IOException {
        if (debug != null && Debug.isOn("handshake")) {
            mesg.print(System.out);
        }
         ...
         */
        final boolean verified = mesg.verify(handshakeHash, Finished.CLIENT,
     ...
     */
    private void sendChangeCipherAndFinish(final boolean finishedTag)
            throws IOException {

        output.flush();

        final Finished mesg = new Finished(protocolVersion, handshakeHash,
     ...
     */
    private SecretKey clientKeyExchange(final RSAClientKeyExchange mesg)
            throws IOException {
     ...
     */
    private void clientCertificate(final CertificateMsg mesg) throws IOException {
        if (debug != null && Debug.isOn("handshake")) {
            mesg.print(System.out);
        }
