...
final class ProviderConfig {
    ...
    private final static com.github.gv2011.javapieces.secutil.Debug debug =
        com.github.gv2011.javapieces.secutil.Debug.getInstance("jca", "ProviderConfig");
    ...
    ProviderConfig(final String className, final String argument) {
    ...
    ProviderConfig(final String className) {
        this(className, "");
    }
        ...
        return AccessController.doPrivileged((PrivilegedAction<Provider>) () -> {
            ...
            try {
                ...
                if (hasArgument() == false) {
                    ...
                    final Constructor<?> cons = provClass.getConstructor(CL_STRING);
