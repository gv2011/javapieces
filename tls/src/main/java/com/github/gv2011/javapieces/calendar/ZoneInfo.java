...
public class ZoneInfo extends TimeZone {
    ...
    public int getOffsets2(final long utc, final int[] offsets) {
    ...
    private int getOffsets(long date, final int[] offsets, final int type) {
        ...
        if (index < transitions.length) {
            final long val = transitions[index];
            final int offset = this.offsets[(int)(val & OFFSET_MASK)] + rawOffsetDiff;
            if (offsets != null) {
    ...
    private int getTransitionIndex(final long date, final int type) {
        ...
        while (low <= high) {
            ...
            final long val = transitions[mid];
   ...
   /**
    ...
    public boolean observesDaylightTime() {
        ...
        // any future.
        final long utc = System.currentTimeMillis() - rawOffsetDiff;
    ...
    public boolean inDaylightTime(final Date date) {
        ...
        final long utc = date.getTime() - rawOffsetDiff;
        final int index = getTransitionIndex(utc, UTC_TIME);
