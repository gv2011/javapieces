...
public final class ZoneInfoFile {
    ...
    static {
        ...
        AccessController.doPrivileged((PrivilegedAction<Object>) () -> {
            try {
                final String libDir = System.getProperty("java.home") + File.separator + "lib";
     ...
     */
    private static void load(final DataInputStream dis) throws ClassNotFoundException, IOException {
        if (dis.readByte() != 1) {
    ...
    private static class ZoneOffsetTransitionRule {
        ...
        ZoneOffsetTransitionRule(final DataInput in) throws IOException {
            ...
            month = data >>> 28;
            dom = (byte)(((data & (63 << 22)) >>> 22) - 32);
            dow = dowByte == 0 ? -1 : dowByte;
            secondOfDay = timeByte == 31 ? in.readInt() : timeByte * 3600;
            timeEndOfDay = timeByte == 24;
            timeDefinition = (data & (3 << 12)) >>> 12;

            standardOffset = stdByte == 255 ? in.readInt() : (stdByte - 128) * 900;
            offsetBefore = beforeByte == 3 ? in.readInt() : standardOffset + beforeByte * 1800;
            offsetAfter = afterByte == 3 ? in.readInt() : standardOffset + afterByte * 1800;
        }
