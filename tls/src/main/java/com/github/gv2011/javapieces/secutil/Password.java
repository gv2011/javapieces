...
public class Password {
    ...
    public static char[] readPassword(final InputStream in) throws IOException {
    ...
    public static char[] readPassword(InputStream in, final boolean isEchoOn)
            throws IOException {
     ...
     */
    private static byte[] convertToBytes(final char[] pass) {
        if (enc == null) {
        ...
        final byte[] ba = new byte[(int)(enc.maxBytesPerChar() * pass.length)];
