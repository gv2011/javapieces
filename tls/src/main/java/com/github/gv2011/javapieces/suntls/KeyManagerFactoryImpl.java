...
import com.github.gv2011.javapieces.tls.KeyManagerFactorySpi;
import com.github.gv2011.javapieces.tls.KeyStoreBuilderParameters;
import com.github.gv2011.javapieces.tls.ManagerFactoryParameters;
...
abstract class KeyManagerFactoryImpl extends KeyManagerFactorySpi {
    ...
    public static final class SunX509 extends KeyManagerFactoryImpl {
        ...
        @Override
        protected void engineInit(final KeyStore ks, final char[] password) throws
        ...
        @Override
        protected void engineInit(final ManagerFactoryParameters spec) throws
    ...
    public static final class X509 extends KeyManagerFactoryImpl {
        ...
        protected void engineInit(final KeyStore ks, final char[] password) throws
            ...
            if (ks == null) {
                ...
                try {
                    final Builder builder = Builder.newInstance(ks,
        ...
        @Override
        protected void engineInit(final ManagerFactoryParameters params) throws
                InvalidAlgorithmParameterException {
