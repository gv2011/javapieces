...
public class KerberosClientKeyExchange extends HandshakeMessage {
    ...
    public KerberosClientKeyExchange(final String serverName,
        final AccessControlContext acc, final ProtocolVersion protocolVersion,
    ...
    public KerberosClientKeyExchange(final ProtocolVersion protocolVersion,
            final ProtocolVersion clientVersion, final SecureRandom rand,
            final HandshakeInStream input, final AccessControlContext acc,
            final Object serverKeys) throws IOException {
    ...
    public void init(final String serverName,
        final AccessControlContext acc, final ProtocolVersion protocolVersion,
        final SecureRandom rand) throws IOException {
    ...
    public void init(final ProtocolVersion protocolVersion,
            final ProtocolVersion clientVersion, final SecureRandom rand,
            final HandshakeInStream input, final AccessControlContext acc,
            final Object ServiceCreds) throws IOException {
