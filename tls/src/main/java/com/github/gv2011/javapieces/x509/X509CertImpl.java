...
import com.github.gv2011.javapieces.provider.X509Factory;
import com.github.gv2011.javapieces.secutil.DerEncoder;
...
import com.github.gv2011.javapieces.secutil.Pem;
...
public class X509CertImpl extends X509Certificate implements DerEncoder {
    ...
    public synchronized void verify(final PublicKey key, String sigProvider)
        ...
        final byte[] rawCert = info.getEncodedInfo();
    ...
    public PublicKey getPublicKey() {
        if (info == null)
            return null;
        try {
            final PublicKey key = (PublicKey)info.get(CertificateX509Key.NAME
    ...
    public int getVersion() {
        if (info == null)
            return -1;
        try {
            final int vers = ((Integer)info.get(CertificateVersion.NAME
    ...
    public SerialNumber getSerialNumberObject() {
        if (info == null)
            return null;
        try {
            final SerialNumber ser = (SerialNumber)info.get(
    ...
    public Principal getSubjectDN() {
        if (info == null)
            return null;
        try {
            final Principal subject = (Principal)info.get(X509CertInfo.SUBJECT + DOT +
    ...
    public X500Principal getSubjectX500Principal() {
        ...
        try {
            final X500Principal subject = (X500Principal)info.get(
    ...
    public Principal getIssuerDN() {
        if (info == null)
            return null;
        try {
            final Principal issuer = (Principal)info.get(X509CertInfo.ISSUER + DOT +
                                                   X509CertInfo.DN_NAME);
            return issuer;
        } catch (final Exception e) {
            return null;
    ...
    public X500Principal getIssuerX500Principal() {
        ...
        try {
            final X500Principal issuer = (X500Principal)info.get(
    ...
    public Date getNotBefore() {
        if (info == null)
            return null;
        try {
            final Date d = (Date) info.get(CertificateValidity.NAME + DOT +
    ...
    public String getSigAlgOID() {
        if (algId == null)
            return null;
        final ObjectIdentifier oid = algId.getOID();
        return (oid.toString());
    }
    ...
    public boolean[] getIssuerUniqueID() {
        if (info == null)
            return null;
        try {
            final UniqueIdentity id = (UniqueIdentity)info.get(
    ...
    public boolean hasUnsupportedCriticalExtension() {
        if (info == null)
            return false;
        try {
            final CertificateExtensions exts = (CertificateExtensions)info.get(
    ...
    public boolean[] getKeyUsage() {
        try {
            ...
            final KeyUsageExtension certExt = (KeyUsageExtension)get(extAlias);
            if (certExt == null)
                return null;
    ...
    public int getBasicConstraints() {
        try {
            ...
            final BasicConstraintsExtension certExt =
                        (BasicConstraintsExtension)get(extAlias);
            if (certExt == null)
                return -1;
    ...
    throws CertificateException, IOException {
        ...
        final AlgorithmId infoSigAlg = (AlgorithmId)info.get(
     ...
     */
    public static String getFingerprint(final String algorithm,
