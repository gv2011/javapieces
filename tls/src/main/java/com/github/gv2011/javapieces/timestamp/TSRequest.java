...
package com.github.gv2011.javapieces.timestamp;
...
public class TSRequest {
    ...
    public TSRequest(final String tSAPolicyID, final byte[] toBeTimeStamped, final MessageDigest messageDigest)
        ...
        policyId = tSAPolicyID;
        hashAlgorithmId = AlgorithmId.get(messageDigest.getAlgorithm());
        hashValue = messageDigest.digest(toBeTimeStamped);
    }
