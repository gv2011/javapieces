...
public class TlsKeyMaterialParameterSpec implements AlgorithmParameterSpec {
    ...
    public TlsKeyMaterialParameterSpec(final SecretKey masterSecret,
            final int majorVersion, final int minorVersion, final byte[] clientRandom,
            final byte[] serverRandom, final String cipherAlgorithm, final int cipherKeyLength,
            final int expandedCipherKeyLength, final int ivLength, final int macKeyLength,
            final String prfHashAlg, final int prfHashLength, final int prfBlockSize) {
