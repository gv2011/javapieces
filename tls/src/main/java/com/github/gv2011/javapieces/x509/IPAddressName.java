...
public class IPAddressName implements GeneralNameInterface {
    ...
    public boolean equals(final Object obj) {
        ...
        final IPAddressName otherName = (IPAddressName)obj;
        final byte[] other = otherName.address;
        ...
        if (address.length == 8 || address.length == 32) {
            ...
            final int maskLen = address.length/2;
            for (int i=0; i < maskLen; i++) {
                final byte maskedThis = (byte)(address[i] & address[i+maskLen]);
                final byte maskedOther = (byte)(other[i] & other[i+maskLen]);
    ...
    throws UnsupportedOperationException {
        ...
        if (inputName == null)
            ...
            final IPAddressName otherName = (IPAddressName)inputName;
            final byte[] otherAddress = otherName.address;
            if (otherAddress.length == 4 && address.length == 4)
                ...
                final int maskOffset = address.length/2;
