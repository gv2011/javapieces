...
public class LocalizedMessage {
     ...
     * @param key
     */
    public LocalizedMessage(final String key) {
        this.key = key;
    }
     ...
     * @return A formatted message string
     */
    public static String getMessageUnbooted(final String key,
        ...
        while ((nextBraceIndex = value.indexOf('{')) >= 0) {
            ...
            final String firstPart = value.substring(0, nextBraceIndex);
            sb.append(firstPart);
            ...
            final String indexStr = value.substring(0, nextBraceIndex);
            try {
