...
public class ConsoleCallbackHandler implements CallbackHandler {
        ...
        throws IOException, UnsupportedCallbackException
    {
        ...
        for (int i = 0; i < callbacks.length; i++) {
            if (callbacks[i] instanceof TextOutputCallback) {
                ...
                final String message = tc.getMessage();
                if (message != null) {
                    text += message;
                }
                if (text != null) {
    ...
    private void doConfirmation(final ConfirmationCallback confirmation)
        throws IOException, UnsupportedCallbackException
    {
        String prefix;
        final int messageType = confirmation.getMessageType();
        switch (messageType) {
        ...
        class OptionInfo {
            String name;
            int value;
            OptionInfo(final String name, final int value) {
                this.name = name;
                this.value = value;
            }
        }
        ...
        OptionInfo[] options;
        final int optionType = confirmation.getOptionType();
        switch (optionType) {
        ...
        case ConfirmationCallback.UNSPECIFIED_OPTION:
            final String[] optionStrings = confirmation.getOptions();
        ...
        final int defaultOption = confirmation.getDefaultOption();
